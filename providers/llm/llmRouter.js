...
const { buildSystemPrompt } = require('@providers/llm/llmPrompt');
const { buildCodePrompt } = require('@providers/llm/codePrompt');
const { buildMathPrompt } = require('@providers/llm/mathPrompt');

const { getActiveAI, markAIUnavailable } = require('@providers/llm/aiSwitch'); // <--- Add markAIUnavailable here
...
// const { runLLM } = require('@providers/llm/llmRunner');
// const chatHistory = require('@providers/llm/chatHistory');
...
// const { getActiveAI, markAIUnavailable } = require('@providers/llm/aiSwitch'); // <--- Add markAIUnavailable here
// const { askChatGPT } = require('@providers/llm/chatgptClient');
// const { askGemini } = require('@providers/llm/geminiClient');
// const { askGroq } = require('@providers/llm/groqClient');
