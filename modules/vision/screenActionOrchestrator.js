...
const { resolveElement } = require('@agents/elementResolver');
const { validateStep } = require('@agents/actionValidator');
const uiState = require('@agents/uiStateStore');
const { mapToDesktop } = require('@agents/coordinateMapper');
...
// const { executeTool } = require('@modules/vision/tools/toolRegistry');
// const { resolveElement } = require('@modules/vision/agent/elementResolver');
// const { validateStep } = require('@modules/vision/agent/actionValidator');
// const uiState = require('@modules/vision/agent/uiStateStore');
...
// const { resolveElement } = require('@modules/vision/agent/elementResolver');
// const { processActionMemory } = require('@modules/vision/cognitiveEngine');
// const { generatePlan } = require('@modules/vision/plannerEngine');
// const { executeTool } = require('@modules/vision/tools/toolRegistry');
// const uiState = require('@modules/vision/agent/uiStateStore');
// const { validateStep } = require('@modules/vision/agent/actionValidator');
// const { buildWorldContext } = require('@modules/vision/agent/worldModel');
